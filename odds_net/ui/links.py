...
#
# Created: Sun May 12 00:27:18 2013
...
class Ui_Links(object):
    def setupUi(self, Links):
        ...
        self.button_previous = QtGui.QPushButton(Links)
        ...
        self.button_next = QtGui.QPushButton(Links)
        ...
        self.button_add = QtGui.QPushButton(Links)
        ...
        self.line_name = QtGui.QLineEdit(Links)
        ...
        self.line_url = QtGui.QLineEdit(Links)
        palette = QtGui.QPalette()
        brush = QtGui.QBrush(QtGui.QColor(243, 237, 255))
        brush.setStyle(QtCore.Qt.SolidPattern)
        palette.setBrush(QtGui.QPalette.Active, QtGui.QPalette.Base, brush)
        ...
        self.label = QtGui.QLabel(Links)
        self.label.setObjectName("label")
        self.verticalLayout_4.addWidget(self.label)
        self.webView = QtWebKit.QWebView(Links)
        palette = QtGui.QPalette()
        brush = QtGui.QBrush(QtGui.QColor(243, 237, 255))
        brush.setStyle(QtCore.Qt.SolidPattern)
        palette.setBrush(QtGui.QPalette.Active, QtGui.QPalette.Base, brush)
        ...
        self.tree_link_bases = QtGui.QTreeWidget(Links)
        palette = QtGui.QPalette()
        brush = QtGui.QBrush(QtGui.QColor(243, 237, 255))
        brush.setStyle(QtCore.Qt.SolidPattern)
        palette.setBrush(QtGui.QPalette.Active, QtGui.QPalette.Base, brush)
        ...
        self.button_save = QtGui.QPushButton(Links)
        icon3 = QtGui.QIcon()
        ...
        self.line_save = QtGui.QLineEdit(Links)
        palette = QtGui.QPalette()
        brush = QtGui.QBrush(QtGui.QColor(243, 237, 255))
        brush.setStyle(QtCore.Qt.SolidPattern)
        palette.setBrush(QtGui.QPalette.Active, QtGui.QPalette.Base, brush)
        ...
        self.button_delete = QtGui.QPushButton(Links)
        icon4 = QtGui.QIcon()
        ...
        self.button_load = QtGui.QPushButton(Links)
        icon5 = QtGui.QIcon()
        ...
        self.tree_url = QtGui.QTreeWidget(Links)
        ...
        self.button_check = QtGui.QPushButton(Links)
        icon6 = QtGui.QIcon()
        ...
        self.button_remove = QtGui.QPushButton(Links)
        icon7 = QtGui.QIcon()
        ...
        self.button_clear = QtGui.QPushButton(Links)
        icon8 = QtGui.QIcon()
        ...
        Links.setTabOrder(self.line_url, self.webView)
        Links.setTabOrder(self.webView, self.button_next)
        Links.setTabOrder(self.button_next, self.button_previous)
